...
*/
- (void)greetWithCompletionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("greet(completionHandler:)")));
@end
...
__attribute__((swift_name("CubanNotaryBusinessEnvironment")))
@interface SharedCubanNotaryBusinessEnvironment : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
@interface SharedNetworkClientKt : SharedBase
+ (SharedKtor_client_coreHttpClient *)getHttpClientConfig:(void (^)(SharedKtor_client_coreHttpClientConfig<id> *))config __attribute__((swift_name("getHttpClient(config:)")));
@end
